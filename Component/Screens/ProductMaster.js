...
export default class ProductMasterUpdate extends React.Component {
  constructor(props) {
    ...
    if (param && param.images) {
      ...
      console.log('images',this.props.navigation.state.params.images);
    }
  }
  componentDidMount() {
    AsyncStorage.getItem('@fcmtoken').then(token => {
      if (token) {
        ...
        let sharedPeople=this.props.navigation.state.params.sharedContactsName;
        this.setState({sharedPeople:sharedPeople});
        let peopleCOntact=this.props.navigation.state.params.peopleContact;
