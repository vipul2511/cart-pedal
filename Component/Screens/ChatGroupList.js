...
export default class AddGroupMember extends React.Component {
    ...
    hideLoading() {
     ...
     componentDidMount(){
      ...
      if(this.props.navigation.state.params && this.props.navigation.state.params.screenName){
        this.setState({screenName:this.props.navigation.state.params.screenName});
