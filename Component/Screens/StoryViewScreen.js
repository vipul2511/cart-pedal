...
class StoryViewScreen extends Component{
    constructor (props) {
        ...
        console.log( 'story ',this.props.navigation.state.params.storyImages);
             ...
             <SliderBox
                ...
                (<View style={{ flexDirection: 'row', marginBottom: 10,marginTop:25,borderRadius:25, alignSelf: 'center',backgroundColor:'#F1F0F2' }}>
                    ...
                    placeholder='Type a message…' style={{
                        ...
                        height: 40, fontSize: 12, paddingLeft: 10, borderWidth: 0,
                    ...
                    <View style={{ width: 40, height: 40, margin: 10, borderRadius: 20, backgroundColor: 'red', justifyContent: 'center' }}>
