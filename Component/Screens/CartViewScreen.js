        ...
        this.showLoading();
         ...
         AsyncStorage.getItem('@access_token').then((accessToken) => {
            if (accessToken) {
              ...
              console.log('props data',this.props.navigation.state.params.cartProduct);
              let productItem=this.props.navigation.state.params.cartProduct.products;
              let removeID=this.props.navigation.state.params.cartProduct.id;
