...
export default class CartDetailsScreen extends React.Component {
    constructor(props) {
        ...
        this.state = {
          ...
          fcmToken:'',
          imageList : [{uri:this.props.navigation.state.params.imageURL}],
          itemOfProduct:''
        }
     ...
     componentDidMount(){
      ...
      AsyncStorage.getItem('@user_id').then((userId) => {
        ...
        this.setState({product_id:this.props.navigation.state.params.whole_data.id})
        ...
        this.setState({currentQuantity:this.props.navigation.state.params.whole_data.quantity});
        if (userId) {
